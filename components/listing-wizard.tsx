      ...
      <div className="container-shell grid min-h-[650px] place-items-center py-16">
        <div className="card max-w-lg p-10 text-center">
          ...
          <p className="mt-4 text-sm leading-7 text-gray-500">
            It now appears on the real BookSwap marketplace.
          </p>
      ...
      <div className="mx-auto max-w-4xl">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[9px] text-gray-400">
            Secure Supabase listing
          </span>
        </div>
        <div className="mt-10 text-center">
          <span className="eyebrow">Pass it forward</span>
          <h1 className="display mt-4 text-5xl font-semibold">List a book.</h1>
          <p className="mt-3 text-xs text-gray-500">
            A clean, considered listing helps the right reader find it.
          </p>
        </div>
        ...
        <div className="card mt-10 p-6 md:p-10">
          {step === 0 && (
            <div>
              <Heading
                ...
                body="Use accurate details so readers can find it."
              />
              <div className="mt-7 grid gap-5">
                ...
                <label>
                  ...
                  <textarea
                    ...
                    placeholder="Condition notes, edition details, and anything the next reader should know..."
                  />
                </label>
              </div>
            </div>
          ...
          {step === 1 && (
            <div>
              <Heading
                title="How has it been loved?"
                body="Honest condition notes build trust."
              />
          ...
          {step === 2 && (
            <div>
              <Heading
                title="Show the real copy."
                body="Upload one to five clear JPEG, PNG, or WebP images, each under 5 MB."
              />
              <label className="mt-7 grid min-h-[180px] cursor-pointer place-items-center rounded-xl border border-dashed border-[#bfae8d] bg-[#fffaf0]/55 text-center">
                ...
                <span>
                  ...
                  <b className="mt-3 block text-xs">Choose book photos</b>
                  <span className="mt-2 block text-[9px] text-gray-500">
                    {files.length
                      ? `${files.length} image${files.length === 1 ? "" : "s"} selected`
                      : "Cover, spine, and any signs of wear"}
                  </span>
                </span>
              </label>
              ...
              <p className="mt-4 flex items-center gap-2 text-[9px] text-gray-500">
                <ShieldCheck size={13} className="text-orange" /> Uploads are
                stored in the protected listing-images bucket.
              </p>
            </div>
          )}
          {step === 3 && (
            <div>
              <Heading
                ...
                body="Review the public card before publishing."
              />
