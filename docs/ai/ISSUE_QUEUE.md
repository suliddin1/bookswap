...
| ------- | --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| EXT-001 | Repository owner                        | Development `SUPABASE_SERVICE_ROLE_KEY` unavailable, so the real anonymous/owner/unrelated/banned/moderator/admin/stale-account matrix cannot run | Exact-project guard, temporary-fixture suite, cleanup, clear preflight, and corrected public dev config complete                                                                      | `npm run test:authorization` exits 0 against `uibatsbzjswmtdvdrlxj`; no production target                |
