...
export const AZ_COPY = {
  ...
  listingForm: {
    ...
    progressLabel: "Elan yaratma addımları",
    stepLabel: (step: number, total: number, title: string) =>
      `${step}/${total}: ${title}`,
    cancel: "Ləğv et",
    ...
    titleRequired: "Kitabın adını ən azı 2 simvolla yaz.",
    author: "Müəllif / mövzu",
    authorRequired: "Müəllif və ya mövzunu ən azı 2 simvolla yaz.",
    category: "Kateqoriya",
    condition: "Vəziyyəti",
    location: "Məkan",
    description: "Təsvir",
    ...
    descriptionMinimum: "Təsviri ən azı 10 simvolla yaz.",
    ...
    price: "Qiymət (AZN)",
    pricePositive: "Sıfırdan böyük qiymət daxil et.",
    protectedUpload:
    ...
    editLoading: "Elan məlumatları yüklənir",
  ...
  notifications: {
    ...
    emailMessageSubject: "BookSwap-da yeni mesaj",
    emailSystemSubject: "BookSwap hesabında yenilik",
    unread: "Oxunmayıb",
  ...
  api: {
    invalidData: "Sorğudakı məlumatlar etibarlı deyil.",
    invalidField: "Bu sahədəki məlumatı yoxla.",
    badRequest: "Sorğunu yoxla və yenidən cəhd et.",
    internalError:
    ...
    invalidId: "İdentifikator etibarlı deyil.",
    invalidSort: "Sıralama seçimi etibarlı deyil.",
    invalidLimit: "Səhifə ölçüsü etibarlı deyil.",
    invalidCursor: "Davam göstəricisi etibarsızdır və ya vaxtı keçib.",
    sellerNotFound: "Satıcı profili tapılmadı.",
    invalidImagePath: "Elan şəkilləri BookSwap üzərindən yüklənməlidir.",
  },
  admin: {
...
const apiErrorLabels: Record<string, string> = {
  ...
  AUTH_ACTION_NOT_FOUND: AZ_COPY.api.authActionNotFound,
  INVALID_QUERY: AZ_COPY.api.invalidQuery,
  INVALID_FILTER: AZ_COPY.api.invalidFilter,
  INVALID_ID: AZ_COPY.api.invalidId,
  INVALID_SORT: AZ_COPY.api.invalidSort,
  INVALID_LIMIT: AZ_COPY.api.invalidLimit,
  INVALID_CURSOR: AZ_COPY.api.invalidCursor,
  LISTING_NOT_FOUND: AZ_COPY.listingDetail.unavailableBody,
  LISTING_UNAVAILABLE: AZ_COPY.listingDetail.unavailableBody,
  SELLER_NOT_FOUND: AZ_COPY.api.sellerNotFound,
  OWN_LISTING: "Öz elanında bu əməliyyatı edə bilməzsən.",
